...
// macro_rules! tensor {
//     ($n:expr) => {
//         pub struct Tensor<consts!($n), F>
//         where
//             F: Default + Copy + AddAssign + Mul<F, Output = F>,
//         {
//             pub coefficients: Vector<consts!($n), F>,
//         }
//     };
// }
...
//         impl<$(const $consts: usize),+, F: Default + Copy + AddAssign +
// Mul<F, Output = F>> Default for  $name<$($consts),+, F> {             fn
// default() -> Self {                 let coefficients =
// <def_builder!($($consts),+; F)>::default();                 $name {
// coefficients }             }
...
// core::fmt::Result {                 f.debug_struct(stringify!($name))
...
//         where
//             F: Add<Output = F> + Copy + Default + AddAssign + Mul<F, Output =
// F>,         {
//             type Output = Self;

//             fn add(self, other: Self) -> Self::Output {
//                 let mut result = Self::default();
//                 add_tensors!(result.coefficients, self.coefficients,
// other.coefficients; $($consts),+);                 result
//             }
//         }
...
//                 let mut result = Self::default();
//                 scalar_mul_tensor!(result.coefficients, self.coefficients,
// scalar; $($consts),+);                 result
//             }
//         }
...
mod tests {
    ...
    fn create_arbitrary_tensor() {
        ...
        let tensor = Tensor::<2, 3, 4, f64>::default();
        dbg!(tensor.coefficients);
    }
